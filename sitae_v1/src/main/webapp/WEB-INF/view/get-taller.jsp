...
<div class="container mt-3">
    ...
    <h1 class="text-center" style="color: white"> Actualizar Taller</h1>
    ...
    <div class="row justify-content-center" style="background: transparent">
        <div class="col-4" style="width:500px; background: white;  border-radius: 5px;">
            ...
            <form action="update-taller" method="post">
                <input type="hidden" name="id" value="${tallerX.id}">

                <div class="mb-3">
                    <label for="controlName" class="form-label">Nombre: </label>
                    <input type="text" class="form-control" id="controlName" name="name" value="${tallerX.name}" required>
                </div>

                <div class="mb-3">

                    <label for="controlName" class="form-label">Tipo: </label>
                    <select class="form-select" aria-label="Default select example" name="type"  value="${tallerX.type}" placeholder="Seleccione..." required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="controlPlace" name="place"  value="${tallerX.place}" required>
                </div>

                <div class="mb-3">
                    <label for="controlName" class="form-label">Horario: </label>
                    <select class="form-select" aria-label="Default select example" name="horario" value="${tallerX.horario}" placeholder="Seleccione..." required>
