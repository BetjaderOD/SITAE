        ...
        <div class="item">
            <form action="<%= request.getContextPath() %>/register" method="post">
                ...
                <div class="form-floating">
                    <input type="text" name="id" required class="form-control" id="floatingInput" placeholder="20213tn031">
                    <label for="floatingInput">Matricula</label>
                </div>
                <div class="form-floating">
                    <input type="text" name="name" required class="form-control" id="floatingInput1" placeholder="Mike">
                    <label for="floatingInput1">Nombre</label>
                </div>
                <div class="form-floating">
                    <input type="email" name="email" required class="form-control" id="floatingInput2" placeholder="20213tn031utez.edu.mx">
                    <label for="floatingInput2">Correo</label>
                </div>
                <div class="form-floating">
                    <input type="password" name="password" required class="form-control" id="floatingPassword" placeholder="2163sygd12">
